...
void PositionPacket::setX(double x)
{
    this->x = x;
}

double PositionPacket::getY() const
{
    return this->y;
}

void PositionPacket::setY(double y)
{
    this->y = y;
}

double PositionPacket::getTime() const
{
    return this->time;
}
...
class PositionPacketDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    PositionPacketDescriptor();
    virtual ~PositionPacketDescriptor();
...
Register_ClassDescriptor(PositionPacketDescriptor);

PositionPacketDescriptor::PositionPacketDescriptor() : omnetpp::cClassDescriptor("PositionPacket", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

PositionPacketDescriptor::~PositionPacketDescriptor()
{
    delete[] propertynames;
}

bool PositionPacketDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<PositionPacket *>(obj)!=nullptr;
}

const char **PositionPacketDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *PositionPacketDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *PositionPacketDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *PositionPacketDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int PositionPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string PositionPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool PositionPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *PositionPacketDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *PositionPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
